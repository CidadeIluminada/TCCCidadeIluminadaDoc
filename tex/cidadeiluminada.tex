...
A seguir será descrito o fluxo principal de utilização do sistema de gerenciamento destinado à Secretaria Municipal de Obras de São José dos Campos, seguindo o fluxograma do fluxo principal do sistema.

\begin{figure}[!htbp]
 \centering
  \begin{minipage}{0.4\textwidth}
    \centering
    \caption{\label{web-fluxograma}Fluxo principal do aplicativo web}
