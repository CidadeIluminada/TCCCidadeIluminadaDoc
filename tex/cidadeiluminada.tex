...
\begin{figure}[!htbp]
 ...
 \frame{\includegraphics[scale=1]{fluxo_app.png}}
...
\begin{figure}[!htbp]
 ...
 \frame{\includegraphics[scale=1]{fluxo_site_sec.png}}
 \legend{Fonte: Produzido pelos autores}
\end{figure}

A seguir será descrito o fluxo principal de utilização do sistema de gerenciamento destinado à Secretaria Municipal de Obras de São José dos Campos, seguindo os fluxograma do fluxo principal do sistema para os usuários da Secretaria de Obras (Figura \ref{fluxo-site-sec}) e para os usuários da URBAM (Figura xxx).
