...
\begin{figure}[!htbp]
 \centering
  \begin{minipage}{0.4\textwidth}
    ...
    \frame{\includegraphics[scale=1]{fluxo_app.jpg}}
...
\begin{figure}[!htbp]
 \centering
  \begin{minipage}{0.4\textwidth}
    ...
    \frame{\includegraphics[scale=0.1]{android/1.png}}
    \legend{Fonte: Produzido pelos autores}
  \end{minipage}
  \hfill
  \begin{minipage}{0.4\textwidth}
    ...
    \frame{\includegraphics[scale=0.1]{android/2.png}}
    \legend{Fonte: Produzido pelos autores}
  \end{minipage}
\end{figure}
...
\begin{figure}[!htbp]
 \centering
  \begin{minipage}{0.4\textwidth}
    ...
    \frame{\includegraphics[scale=0.1]{android/3.png}}
    \legend{Fonte: Produzido pelos autores}
  \end{minipage}
  \hfill
  \begin{minipage}{0.4\textwidth}
    ...
    \frame{\includegraphics[scale=0.1]{android/4.png}}
    \legend{Fonte: Produzido pelos autores}
  \end{minipage}
\end{figure}
...
\begin{figure}[!htbp]
 \centering
  \begin{minipage}{0.4\textwidth}
    ...
    \frame{\includegraphics[scale=0.1]{android/5.png}}
    \legend{Fonte: Produzido pelos autores}
  \end{minipage}
  \hfill
  \begin{minipage}{0.4\textwidth}
    ...
    \frame{\includegraphics[scale=0.1]{android/6.png}}
    \legend{Fonte: Produzido pelos autores}
  \end{minipage}
\end{figure}
...
\begin{figure}[!htbp]
 \centering
  \begin{minipage}{0.4\textwidth}
    ...
    \frame{\includegraphics[scale=0.1]{android/7.png}}
    \legend{Fonte: Produzido pelos autores}
  \end{minipage}
  \hfill
  \begin{minipage}{0.4\textwidth}
    ...
    \frame{\includegraphics[scale=0.1]{android/8.png}}
    \legend{Fonte: Produzido pelos autores}
  \end{minipage}
\end{figure}
...
\begin{figure}[!htbp]
 \centering
  \begin{minipage}{0.4\textwidth}
    ...
    \frame{\includegraphics[scale=0.1]{android/9.png}}
    \legend{Fonte: Produzido pelos autores}
  \end{minipage}
\end{figure}
...
\begin{figure}[!htbp]
 \centering
  \begin{minipage}{0.4\textwidth}
    ...
    \frame{\includegraphics[scale=1]{fluxo_site_sec.jpg}}
    \legend{Fonte: Produzido pelos autores}
  \end{minipage}
\end{figure}

A seguir será descrito o fluxo principal de utilização do sistema de gerenciamento destinado à Secretaria Municipal de Obras de São José dos Campos, seguindo os fluxograma do fluxo principal do sistema para os diferentes usuários.

Para iniciar, o usuário da secretaria (Figura \ref{fluxo-site-sec}) faz o login no sistema e abre o menu Protocolos onde os protocolos estão listados, como mostrado na Figura \ref{site-tela-inicial}.

\begin{figure}[!htbp]
 \centering
 \caption{\label{site-tela-inicial}Lista de protocolos}
 \frame{\includegraphics[scale=0.25]{site/1-lista_protocolos.png}}
 \legend{Fonte: Produzido pelos autores}
\end{figure}
...
\begin{figure}[!htbp]
 ...
 \frame{\includegraphics[scale=0.25]{site/2-novo_protocolo.png}}
 \legend{Fonte: Produzido pelos autores}
\end{figure}
...
\begin{figure}[!htbp]
 ...
 \frame{\includegraphics[scale=0.25]{site/3-seleciona_poste.png}}
 \legend{Fonte: Produzido pelos autores}
\end{figure}
...
\begin{figure}[!htbp]
 ...
 \frame{\includegraphics[scale=0.25]{site/4-lista_postes.png}}
 \legend{Fonte: Produzido pelos autores}
\end{figure}
...
\begin{figure}[!htbp]
 ...
 \frame{\includegraphics[scale=0.25]{site/5-historico_manutencao_poste.png}}
 \legend{Fonte: Produzido pelos autores}
\end{figure}
...
\begin{figure}[!htbp]
 ...
 \frame{\includegraphics[scale=0.25]{site/6-protocolos_poste.png}}
 \legend{Fonte: Produzido pelos autores}
\end{figure}
...
\begin{figure}[!htbp]
 ...
 \frame{\includegraphics[scale=0.25]{site/7-tela_secretaria.png}}
 \legend{Fonte: Produzido pelos autores}
\end{figure}
...
\begin{figure}[!htbp]
 ...
 \frame{\includegraphics[scale=0.25]{site/8-bairro.png}}
 \legend{Fonte: Produzido pelos autores}
\end{figure}
...
\begin{figure}[!htbp]
 ...
 \frame{\includegraphics[scale=0.25]{site/9-poste_selecionado.png}}
 \legend{Fonte: Produzido pelos autores}
\end{figure}
...
\begin{figure}[!htbp]
 ...
 \frame{\includegraphics[scale=0.25]{site/11-os_gerada.png}}
 \legend{Fonte: Produzido pelos autores}
\end{figure}
...
\begin{figure}[!htbp]
 ...
 \frame{\includegraphics[scale=0.25]{site/12-pdf.png}}
 \legend{Fonte: Produzido pelos autores}
\end{figure}
...
\begin{figure}[!htbp]
 ...
 \frame{\includegraphics[scale=0.25]{site/13-urbam.png}}
 \legend{Fonte: Produzido pelos autores}
\end{figure}
...
\begin{figure}[!htbp]
 ...
 \frame{\includegraphics[scale=0.25]{site/14-servico_os.png}}
 \legend{Fonte: Produzido pelos autores}
\end{figure}
...
\begin{figure}[!htbp]
 ...
 \frame{\includegraphics[scale=0.25]{site/15-fechamento_urbam.png}}
 \legend{Fonte: Produzido pelos autores}
\end{figure}
...
\begin{figure}[!htbp]
 ...
 \frame{\includegraphics[scale=0.25]{site/16-material_e_motivo.png}}
 \legend{Fonte: Produzido pelos autores}
\end{figure}
...
\begin{figure}[!htbp]
 ...
 \frame{\includegraphics[scale=0.25]{site/17-os_feita.png}}
 \legend{Fonte: Produzido pelos autores}
\end{figure}
...
\begin{figure}[!htbp]
 ...
 \frame{\includegraphics[scale=0.25]{site/18-os_confirmacao.png}}
 \legend{Fonte: Produzido pelos autores}
\end{figure}
...
\begin{figure}[!htbp]
 ...
 \frame{\includegraphics[scale=0.25]{site/19-os_confirmando.png}}
 \legend{Fonte: Produzido pelos autores}
\end{figure}
...
\begin{figure}[!htbp]
 ...
 \frame{\includegraphics[scale=0.25]{site/20-os_confirmada.png}}
 \legend{Fonte: Produzido pelos autores}
\end{figure}
