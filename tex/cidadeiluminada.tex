...
\begin{figure}[!htbp]
 \centering
  \begin{minipage}{0.4\textwidth}
    \centering
    \caption{\label{fluxo-site}Fluxo principal do aplicativo web}
    \frame{\includegraphics[scale=1]{fluxo_site.jpg}}
    \legend{Fonte: Produzido pelos autores}
  \end{minipage}
\end{figure}

A seguir será descrito o fluxo principal de utilização do sistema de gerenciamento destinado à Secretaria Municipal de Obras de São José dos Campos, seguindo o fluxograma do fluxo principal do sistema \ref{fluxo-site}.
